...
public class RaceTrackInspector : Editor
{
    ...
    private const float pickSize = 4f;
    
    private const float directionalScale = 24f;
    ...
    private Vector3 ShowPoint(int index)
    {
        ...
        {
            size *= 1.5f;
            handleCap = Handles.CylinderHandleCap;
        }
        ...
        if (Handles.Button(point, handleRotation, size * handleSize, size * pickSize, handleCap))
        {
            selectedIndex = index;
            Repaint();
        }
