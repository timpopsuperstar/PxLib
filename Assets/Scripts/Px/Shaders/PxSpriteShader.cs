...
public class PxSpriteShader : MonoBehaviour
{
    ...
    public void SetMultiply(Color color, float intensity = 1, bool resetSprite = false)
    {
        if (resetSprite)
        {
            ResetSprite();
        }
        MultiplyBlending = true;
        MultiplyColor = color;
        MultiplyIntensity = intensity;
    }
    public void SetAdd(Color color, float intensity = 1, bool resetSprite = false)
    {
        if (resetSprite)
        {
            ResetSprite();
    ...
    public void SetGrayscale(float intensity = 1, bool resetSprite = true)
    {
        if (resetSprite)
        {
            ResetSprite();
        ...
        GrayscaleBlending = true;
    }
    public void SetDisableGeneric(bool resetSprite = true)
    {
        if (resetSprite)
        {
            ResetSprite();
