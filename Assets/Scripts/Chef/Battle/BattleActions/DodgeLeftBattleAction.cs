...
[CreateAssetMenu(menuName = "Chef/ScriptableObjects/BattleActions/DodgeLeftBattleAction")]
public class DodgeLeftBattleAction : BattleAction
{
    private const int dodgeSteps = 12;

    protected override IEnumerator IEAct(BattleActor actor)
    {
        actor.Anim = actor.AnimSet.dodgeLeft;
